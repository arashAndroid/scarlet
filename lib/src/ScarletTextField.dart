...
import 'helpers/ScarletInputDecoration.dart';

class ScarletTextField extends StatefulWidget {
  ...
  const ScarletTextField({
    Key key,
    this.controller,
    this.focusNode,
    this.decoration = scarletInputDecoration,
  ...
  @override
  _ScarletTextFieldState createState() => _ScarletTextFieldState();
...
class _ScarletTextFieldState extends State<ScarletTextField> {
  @override
